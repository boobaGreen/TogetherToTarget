...
_Documentazione aggiornata: 9 Agosto 2025_
...
const FALLBACK_SCENARIO = {
  ...
  message:
    "🤔 Dopo 3 giorni non abbiamo trovato compagni compatibili. Cosa vuoi fare?",
  options: [
    {
...
const WEEKLY_RECALL_EMAIL = {
  ...
  template: {
    message:
      'Ciao [NOME], stiamo ancora cercando compagni per il tuo obiettivo "[OBIETTIVO]".',
    stats:
      "Questa settimana [N] nuovi utenti si sono uniti alla tua categoria.",
    options: [
      {
...
_Documentazione pronta per implementazione. Un altro AI può continuare lo sviluppo seguendo queste specifiche dettagliate._
