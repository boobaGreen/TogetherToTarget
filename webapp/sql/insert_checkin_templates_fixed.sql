-- Template form per le principali sottocategorie - VERSIONE CORRETTA
-- Da eseguire dopo create_daily_checkin_system.sql
-- Usa i category_id corretti dal database esistente

-- Prima elimina eventuali template esistenti per ripartire pulito
DELETE FROM checkin_form_templates;

-- 1. SALUTE E FITNESS (category_id dovrebbe essere intorno a 8-14 dopo gli aggiornamenti)
-- Usiamo una query per ottenere l'ID corretto
